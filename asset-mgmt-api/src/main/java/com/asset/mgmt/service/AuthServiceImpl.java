...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponse register(Users user) {
        try {
            if (user.getEmail() == null || user.getPassword() == null || user.getEmail().isBlank()
            ...
            Users savedUser = userRepo.save(user); // ✅ use saved user with ID populated

            String token = jwtUtil.generateToken(userDetailsImpl.loadUserByUsername(savedUser.getEmail()));
    ...
    public LoginResponse login(Users user) {
        try {
            ...
            UserDetails userDetails = userDetailsImpl.loadUserByUsername(authentUser.getEmail());

            String token = jwtUtil.generateToken(userDetails);

            return new LoginResponse(token, authentUser.getId(), authentUser.getEmail());
